<body class="hold-transition login-page" style="background-image: url('<?php echo base_url(); ?>assets/design/img/bg-login.jpg');background-position: center;
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form id="defaultForm" method="post" class="" action="<?php echo base_url('admin/loginpost'); ?>">
